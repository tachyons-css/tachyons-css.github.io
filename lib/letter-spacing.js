...
var moduleCss = fs.readFileSync('node_modules/tachyons-letter-spacing/css/tachyons-letter-spacing.min.css', 'utf8')
var moduleObj = cssstats(moduleCss)
var moduleSize = filesize(moduleObj.gzipSize)
var moduleName = module.name.split("tachyons-").pop()

var srcCSS = fs.readFileSync('./src/css/_letter-spacing.css', 'utf8')
...
var template = fs.readFileSync('./src/templates/docs/tracking/index.html', 'utf8')
