...
var moduleCss = fs.readFileSync('node_modules/tachyons-font-weight/css/tachyons-font-weight.min.css', 'utf8')
var moduleObj = cssstats(moduleCss)
var moduleSize = filesize(moduleObj.gzipSize)
var moduleName = module.name.split("tachyons-").pop()

var srcCSS = fs.readFileSync('./src/css/_font-weight.css', 'utf8')
...
var template = fs.readFileSync('./src/templates/docs/font-weight/index.html', 'utf8')
