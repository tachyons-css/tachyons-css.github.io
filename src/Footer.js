...
export default () =>
  <footer className='bg-white black-70 ph3 ph5-ns pv5 pv6-ns bt b--black-10'>
    <div className='mw9 center'>
      <div className='mb5 lh-copy'>
        ...
        <Link className='black-70 link hover-blue b dib mr3 mb3' to='/docs/' title='Docs'>
          Docs
        </Link>
        <Link className='black-70 link hover-blue b dib mr3 mb3' to='/components/' title='Components'>
          Components
        </Link>
        <Link className='black-70 link hover-blue b dib mr3 mb3' to='/gallery/' title='Gallery of Sites built with Tachyons'>
          Gallery
        </Link>
        <Link className='black-70 link hover-blue b dib mr3 mb3' to='/resources/' title='Resources related to Tachyons'>
          Resources
        </Link>
        <Link className='black-70 link hover-blue b dib mr3 mb3' to='/xray/' title='The X-Ray chrome extension for aligning things to a grid.'>
          X-Ray
        </Link>
  ...
  <svg xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 16 16' fill-rule='evenodd' clip-rule='evenodd' stroke-linejoin='round' stroke-miterlimit='1.414'><path d='M8 0C3.58 0 0 3.582 0 8c0 3.535 2.292 6.533 5.47 7.59.4.075.547-.172.547-.385 0-.19-.007-.693-.01-1.36-2.226.483-2.695-1.073-2.695-1.073-.364-.924-.89-1.17-.89-1.17-.725-.496.056-.486.056-.486.803.056 1.225.824 1.225.824.714 1.223 1.873.87 2.33.665.072-.517.278-.87.507-1.07-1.777-.2-3.644-.888-3.644-3.953 0-.873.31-1.587.823-2.147-.083-.202-.358-1.015.077-2.117 0 0 .672-.215 2.2.82.638-.178 1.323-.266 2.003-.27.68.004 1.364.092 2.003.27 1.527-1.035 2.198-.82 2.198-.82.437 1.102.163 1.915.08 2.117.513.56.823 1.274.823 2.147 0 3.073-1.87 3.75-3.653 3.947.287.246.543.735.543 1.48 0 1.07-.01 1.933-.01 2.195 0 .215.144.463.55.385C13.71 14.53 16 11.534 16 8c0-4.418-3.582-8-8-8'></path></svg>
      ...
      <div className='pt4 cf mw5'>
        <script async='' src='//www.google-analytics.com/analytics.js'></script><script async='' type='text/javascript' src='//cdn.carbonads.com/carbon.js?zoneid=1673&amp;serve=C6AILKT&amp;placement=tachyonsio' id='_carbonads_js'></script><div id='carbonads'><span><span className='carbon-wrap'><a href='//srv.carbonads.net/ads/click/x/GTND42QJCE7IL2QLCV74YKQMC6BDCK7NFTBDEZ3JCWYIVKJMCYYIEKQKC6BI423IF6BDTK3EHJNCLSIZZRLCP7I35MNFV?segment=placement:tachyonsio;&amp;encredirect=https%3A%2F%2Fad.doubleclick.net%2Fddm%2Ftrackclk%2FN5295.1676840CARBONADS.COM%2FB10444636.207316239%3Bdc_trk_aid%3D407009849%3Bdc_trk_cid%3D75142946%3Bdc_lat%3D%3Bdc_rdid%3D%3Btag_for_child_directed_treatment%3D' className='carbon-img' target='_blank' rel='noopener'><img src='https://pro.buysellads.com/p/manage/asset/id/58085' alt='' border='0' height='100' width='130' style={{ maxWidth: '130px', display: 'none' }} /></a><a href='//srv.carbonads.net/ads/click/x/GTND42QJCE7IL2QLCV74YKQMC6BDCK7NFTBDEZ3JCWYIVKJMCYYIEKQKC6BI423IF6BDTK3EHJNCLSIZZRLCP7I35MNFV?segment=placement:tachyonsio;&amp;encredirect=https%3A%2F%2Fad.doubleclick.net%2Fddm%2Ftrackclk%2FN5295.1676840CARBONADS.COM%2FB10444636.207316239%3Bdc_trk_aid%3D407009849%3Bdc_trk_cid%3D75142946%3Bdc_lat%3D%3Bdc_rdid%3D%3Btag_for_child_directed_treatment%3D' className='carbon-text' target='_blank' rel='noopener'>Learn and build on GCP for free. Try it free today.</a></span><a href='http://carbonads.net/?utm_source=tachyonsio&amp;utm_medium=ad_via_link&amp;utm_campaign=in_unit&amp;utm_term=carbon' className='carbon-poweredby' target='_blank' rel='noopener'>ads via Carbon</a><img src='https://ad.doubleclick.net/ddm/trackimp/N5295.1676840CARBONADS.COM/B10444636.207316239;dc_trk_aid=407009849;dc_trk_cid=75142946;ord=151439449;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=?' border='0' height='1' width='1' style={{ display: 'none' }} /></span></div>
      </div>
