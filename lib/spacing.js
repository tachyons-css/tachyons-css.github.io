...
var module = require('tachyons-spacing/package.json')
var moduleCss = fs.readFileSync('node_modules/tachyons-spacing/css/tachyons-spacing.min.css', 'utf8')
var moduleObj = cssstats(moduleCss)
var moduleSize = filesize(moduleObj.gzipSize)
var moduleName = module.name.split("tachyons-").pop()

var srcCSS = fs.readFileSync('./src/css/_spacing.css', 'utf8')
