...
var moduleCss = fs.readFileSync('node_modules/tachyons-images/css/tachyons-images.min.css', 'utf8')
var moduleObj = cssstats(moduleCss)
var moduleSize = filesize(moduleObj.gzipSize)
var moduleName = module.name

var srccss = fs.readFileSync('./src/css/_images.css', 'utf8')
...
var template = fs.readFileSync('./src/templates/docs/images/index.html', 'utf8')
...
fs.writeFileSync('./docs/elements/images/index.html', html)
