...
var module = require('tachyons-position/package.json')
var moduleCss = fs.readFileSync('node_modules/tachyons-position/css/tachyons-position.min.css', 'utf8')
var moduleObj = cssstats(moduleCss)
var moduleSize = filesize(moduleObj.gzipSize)
var moduleName = module.name

var srccss = fs.readFileSync('./src/css/_position.css', 'utf8')
