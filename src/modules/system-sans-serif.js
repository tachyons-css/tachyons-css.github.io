...
var template = fs.readFileSync('./src/templates/docs/system-sans-serif/index.html', 'utf8')
...
fs.writeFileSync('./docs/typography/font-family/system-sans-serif/index.html', html)
