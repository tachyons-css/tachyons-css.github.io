...
<html lang="en">
<head>
<title>TACHYONS - Articles | Title Highlight Header Cover</title>
...
<main>
  ...
  <h1 class="f4 f3-ns mt4">Title Highlight Header Cover</h1>
<div class="cf">
...
<h2 class="f5">css</h2>
<pre class="pa3 ba br2 b--black-10 h5" id="css">.bl {
...
<div class="cf">
  <div class="fl w-100">
    ...
    <dl class="dib mr4 mt0">
      ...
      <dd class="ml0 b f3 f2-ns">670<small class="f6">B</small>
      </dd>
    </dl>
    <dl class="dib mr4 mt0">
  ...
  <div class="fl w-100">
    ...
    <li class="fl w-100 w-50-m w-33-ns"><a class="f5 link dim blue fw6" href="https://github.com/tachyons-css/tachyons-border-widths">tachyons-border-widths</a></li>
  ...
  <code class="f6">npm i --save tachyons-borders tachyons-border-colors tachyons-border-widths tachyons-display tachyons-font-family tachyons-font-style tachyons-font-weight tachyons-letter-spacing tachyons-line-height tachyons-max-widths tachyons-skins tachyons-spacing tachyons-text-transform tachyons-type-scale tachyons-typography tachyons-utilities</code>
